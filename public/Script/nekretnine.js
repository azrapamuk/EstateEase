    ...
    if (filtriraneNekretnine.length === 0) {
        ...
        filtriraneNekretnine.forEach(nekretnina => {
            ...
            detaljiDugme.addEventListener('click', function () {
                ...
                // Kreiranje URL-a za detalje stranicu, prosljeđujući ID nekretnine kao query parametar
                const detaljiURL = `detalji.html?id=${idNekretnine}`; // Pretpostavka da imate detalji.html stranicu

                // Preusmjeravanje na detalje stranicu
...
/* spojiNekretnine(divReferenca, instancaModula, tip_nekretnine) {
    // pozivanje metode za filtriranje
    const filtriraneNekretnine = instancaModula.filtrirajNekretnine({ tip_nekretnine: tip_nekretnine });
